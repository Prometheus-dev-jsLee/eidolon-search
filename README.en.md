...
FTS5 index + snippet extraction = 90%+ reduction (1.5K)
...
| Feature | Description |
|---------|-------------|
| 🔍 **Fast Search** | FTS5-based full-text search with 90%+ token reduction (measured: 93~98.9%) |
...
→ Same accuracy, 90%+ token reduction
```

**Expected performance:** Around 90%  
